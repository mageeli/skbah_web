            ...
            <div id="menu" class="navbar">
              <div class="nav-responsive">
                <ul class="nav navbar-nav main-navigation">
                  ...
                  <?php } else { ?>
                  <li class="main_cat"><a href="<?php echo $category['href']; ?>"><?php echo $category['name']; ?>                  
               		</a>  
                    <div class="dropdown-menu">
                    <?php if ($category['thumb']) { ?>
                    <img src="<?php echo $category['thumb']; ?>" alt="" title="" class="img-thumbnail" />
...
<!-- <?php if ($category['thumb']) { ?>
     ...
     <ul class="nav nav-tabs">
             <li class="active"><a href="#responsive-menu" data-toggle="tab">قائمة</a></li>
            <li><a href="#tab-account" data-toggle="tab">الحساب</a></li>
			<!-- <li><a href="#tab-settings" data-toggle="tab">الإعدادات</a></li>  -->
          </ul>
      ...
      <div class="header-right col-md-2 col-sm-6 col-xs-4">
        ...
        <div class="header_menu_dropdown pull-right">
          ...
          <div id="top-links" class="nav">
            ...
            <?php echo $currency; ?> <?php echo $language; ?> </div>
        </div>

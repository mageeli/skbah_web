            ...
            <div id="menu" class="navbar">
              <div class="nav-responsive">
                <ul class="nav navbar-nav main-navigation">
                  ...
                  <?php } ?>
                  <?php } ?>
                  <li class="main_cat"> <a href="<?php echo $all_blogs; ?>"><?php echo $text_blog; ?></a>
                  </li>
                </ul>
              </div>
            </div>
...
<?php foreach ($categories as $category) { ?>
<?php if ($category['children']) { ?>
<div class="btn btn-default seemore"><a href="<?php echo $category['href']; ?>">See More Products</a></div>
<?php } ?>
<?php } ?>
<?php } ?>

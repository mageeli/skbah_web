  ...
  <div id="footer" class="container">
    <div class="row footer_block"> 
      ...
      <div class="col-xs-12 col-sm-12 col-md-3 column information">
        ...
        <h5 class="collapsed" data-target="#dropdown-menu" data-toggle="collapse"><?php echo $text_information; ?>
    ...
    <div class="Footer-bottom">
      ...
      <div class="copy-right col-md-4 col-sm-12 col-xs-12">
        <div id="powered">الحقوق محفوظه لمؤسسة سكبه لتنقية المعلومات</div>
      </div>

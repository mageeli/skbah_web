...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom,#module-footerleft,#module-footerright').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom, #module-footerleft ,#module-footerright').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>